  ...
  class GunController extends entity.Component {
    ...
    ChangeWeapon(weapon){
      ...
      e.AddComponent(new render_component.RenderWeapon({
        ...
        obj: './static/Models/Weapon_Pack/'+weapon+'.obj',
        mtl: './static/Models/Weapon_Pack/'+weapon+'.mtl',
      ...
      // Gun Rota                       Haut/Bas
      const q1 = new THREE.Quaternion(0,Math.PI/3,-0.07,0)
